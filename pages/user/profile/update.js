...
const Profile = ({user, token}) => {
	...
	const updateForm = () => (
		...
		<form onSubmit = {handleSubmit}>
			...
			<div className="form-group">
				<input disabled value={email} onChange = {handleChange('email')} type="email" className="form-control" placeholder="Type your email" required/>
			</div>


			<div className="form-group">
				<label className="text-muted">Please pick your favourite categories</label>
